            ...
            modelBuilder.Entity("RentACar.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "42a59941-5d84-49cb-9ec0-a12b45b3a83c",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "dcc61d55-761a-4f2a-9f5b-57ab55f42dde",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "42e86c83-80ed-49c5-b55a-4b6d986a5f83",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("RentACar.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1b0b4fc1-7a99-4187-b00f-735315ac5b33",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGE69ISBeh8bLbtGc+7Et82nsDgbHjXLneQZFiAKPWtPSoXYsQfaqaD3wTveMpHQMw==",
                            PhoneNumber = "+905555555555",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9235be5d-63f0-4837-a7e3-b1b7352a48d1",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d4838951-c810-488a-b16d-368a443f54a5",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEL1yIiaEX4Rka1OHMeSkBznpC2rTlcmWegx20vy0t8jr5+UDFBKUQbJmIaMBRRcm/Q==",
                            PhoneNumber = "+905555555555",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d7afadc8-30a5-445b-97a3-0203cc9ff471",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("RentACar.Entity.Entities.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6049), new TimeSpan(0, 3, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Mercedes"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Deneme",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6074), new TimeSpan(0, 3, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Audi"
                        });
                });
            ...
            modelBuilder.Entity("RentACar.Entity.Entities.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47b58545-8535-4be8-9a44-7bfde556b20c"),
                            BrandId = new Guid("76f3368d-44f7-4377-ba91-b394b00737d4"),
                            CategoryId = new Guid("eeabec77-1ef1-46e1-a5e9-3b0ceffbb6a4"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6487), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("d20154ef-2de9-496e-b131-17601b27bb6b"),
                            BrandId = new Guid("e37eb9b9-181b-4ca4-ad97-646f2b9d338b"),
                            CategoryId = new Guid("8d0e6f75-280c-4b1b-a703-336ae28020ef"),
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6503), new TimeSpan(0, 3, 0, 0, 0)),
                            Description = "In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available.",
                            FuelType = "Benzin",
                            IsDeleted = false,
                            Kilometer = 62511,
            ...
            modelBuilder.Entity("RentACar.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryName = "Spor",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6722), new TimeSpan(0, 3, 0, 0, 0)),
                            IsDeleted = false
                        },
                        new
                        {
                            ...
                            CategoryName = "Sedan",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6731), new TimeSpan(0, 3, 0, 0, 0)),
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("RentACar.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6921), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 2, 22, 21, 9, 9, 574, DateTimeKind.Unspecified).AddTicks(6931), new TimeSpan(0, 3, 0, 0, 0)),
